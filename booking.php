                                ...
                                <div class="tab-pane active" role="tabpanel" id="step1">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div id="formCol">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div id="addWay">Add Watpoint</div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <label>Pick Up Address</label>
                                                        <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <button type="button" class="default-btn next-step">Continue to
                                                            next
                                                            step</button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <p>Airport Taxi Booking specializes in airport transfers to and from all UK
                                                airports.</p>
                                            <p>
                                                Our taxi network stretches across the UK, helping us provide you with a
                                                fast, safe and affordable airport taxi service 24 hours a day 7 days a
                                                week.
                                            </p>
                                            <p>
                                            ...
                                            <ul>
                                                <li>
                                                    Multiple Vehicle Options – we provide normal, executive and MPV
                                                    vehicles for your travel needs
                                                </li>
                                                <li>
                                                    Competitive Rates – Our rates are low without compromising on
                                                    service
                                                </li>
                                                <li>
                                                    English Customer Service – Whatever your enquiry, we’re always
                                                    online to help via WhatsApp, Phone, Email & Facebook Messenger
                                                </li>
                                                <li>
                                                    CRB-Checked Drivers – All of our drivers are CRB checked providing
                                                    you with a safe taxi experience
                                                </li>
                                                <li>
                                                    Flight Tracking – Worried about a delay or early arrival? Our
                                                    drivers check the flight status to ensure you aren’t waiting around
                                                </li>
                                                <li>
                                                    Meet & Greet – Airports can be confusing, our drivers will meet you
